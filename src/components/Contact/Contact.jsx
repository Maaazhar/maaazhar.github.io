                    ...
                    <div className="contact-content">
                        <div className="column left">
                            ...
                            <div className="contact-icon">
                                <a title="Mazharul Islam on LinkedIn" href="https://www.linkedin.com/in/maaazhar/"
                                    target="_blank"> <i className="fab fa-linkedin"></i> </a>
                                <a title="Mazharul Islam on GitHub" href="https://github.com/Maaazhar" target="_blank"> <i
                                    className="fab fa-github-square"></i> </a>
                                <a title="Mazharul Islam on Code pen" href="https://codepen.io/maaazhar" target="_blank"> <i
                                    className="fab fa-codepen"></i> </a>
                                <a title="Mazharul Islam on Code sand box" href="https://codesandbox.io/u/Maaazhar"
                                    target="_blank">
                                ...
                                <a title="Mazharul Islam on Facebook" href="https://www.facebook.com/MAAAZHAAAR/" target="_blank"> <i className="fab fa-facebook-square"></i></a>
                            ...
                            <div className="icons">
                                ...
                                <div className="row">
                                    ...
                                    <div className="info">
                                        ...
                                        <div className="sub-title"><a href="tel:+971557517099">+971 55 751 7099</a></div>
                                    </div>
                                </div>
                                <div className="row">
                                    ...
                                    <div className="info">
                                        ...
                                        <div className="sub-title"><a
                                            href="mailto:mailformazhar@gmail.com">mailformazhar@gmail.com</a></div>
                                    </div>
                                </div>
                                <div className="row">
                                    ...
                                    <div className="info">
                                        ...
                                        <div className="sub-title"><a target="_blank"
                                            href="https://maps.app.goo.gl/8MdpjKg6kGaM47h99">Abu Dhabi, United Arab
                                            Emirates.</a></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="column right">
                            ...
                            <form className="contact-form" action="#" method="POST">
                                <div className="field">
                                    <input type="text" className="fullname" placeholder="Type Your Full Name"/>
                                </div>
                                <div className="fields">
                                    <div className="field name">
                                        <input type="number" className="fullname" placeholder="Type Your Mobile Number"/>
                                    </div>
                                    <div className="field email">
                                        <input type="text" className="email-input" placeholder="Type Your Email Address"/>
                                    </div>
                                </div>
