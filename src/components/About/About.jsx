        ...
        <div className="max-width">
            ...
            <div className="about-content">
                ...
                <div className="column right">
                    <div className="text">Hi there! Call me <span> Maz-har </span> and reach me out for <span
                            className="aboutWork"><span className="typing"></span></span></div>
                    <p>
                    ...
                    <div className="about-btn">
                        <a target="_blank"
                            ...
                            title="Download Resume">Download Resume</a>
                    </div>
                </div>
            </div>
        </div>
